...
while True:
    #скорость блока - прохождение одного блоков в течении
    #данного промежутка времени
    v= 1/t 

    craft.postToChat(" скорость блока v = "+ str(v)+ " блока/c")
    
    # движение блока с определённой скоростью
    for i in range(10):
        #Создания блоков для определения пройденного расстояния
        # при заданной скорости
        craft.setBlock(x+i,y+y1,z+z1, 35,3)
